...
def term_grade(class_total_grades,student_names):
    ...
    falling = np.sum(class_total_grades < 60)
    print("**********************************")
    ...
    print(f"Kaç Kişi Geçti: {passing} | Kaç Kişi Kaldı: {falling}")
    print("**********************************")
...
def main():
    try:
        ...
        print(f"Hata: Klasörde '{csv_file}' dosyası bulunamadı!")
        print("Lütfen projenizin çalıştığı dizinde bu dosyayı oluşturun.")
        return
